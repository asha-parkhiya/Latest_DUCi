...
public class BluetoothTopicAdapter extends RecyclerView.Adapter<BluetoothTopicAdapter.ViewHolder> {

    Context context;
    private List<String> bluetoothDeviceList;

    public BluetoothTopicAdapter(Context context, List<String> bluetoothDeviceList) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_bluetooth_topic_list, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        final String bluetoothDevice = bluetoothDeviceList.get(position);
...
//                getColor(firstletter.toUpperCase(), holder.cv_color);
            ...
            holder.tv_wifi_name.setText(bluetoothDevice);
            holder.tv_wifi_name.setTypeface(holder.tv_wifi_name.getTypeface(), Typeface.BOLD);
//            String fname = bluetoothDevice.getName();
...
//        }else {
//            holder.tv_wifi_bssid.setText(bluetoothDevice.getAddress());
//        }
    }
