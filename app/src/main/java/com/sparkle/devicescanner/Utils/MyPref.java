...
public class MyPref {
    ...
    public void setPref1(String key, List<DeviceType> val) {
        Gson gson1 = new Gson();
        String json1 = gson1.toJson(val);
        editor.putString(key, json1);
        editor.commit();
    ...
    public String getPref1(String key, List<DeviceType> val) {

        return pref.getString(key, String.valueOf(val));
    }

    public void setPref3(String key, List<ToDo> val) {
        Gson gson1 = new Gson();
        String json1 = gson1.toJson(val);
        editor.putString(key, json1);
        editor.commit();
    ...
    public String getPref3(String key, List<ToDo> val) {
